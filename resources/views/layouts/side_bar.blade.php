          ...
          <ul class="side-menu metismenu">
              ...
              <li>
                  ...
                  <ul class="nav-2-level collapse">
                      ...
                      <li>
                          <a href="/product_categories/create">Create Category</a>
                      </li>
                      <li>
                          <a href="/product_categories">Manage Category</a>
                      </li>
                  </ul>
              </li>
              <li>
                  ...
                  <ul class="nav-2-level collapse">
                      <li>
                          <a href="/stocks/create">Create Stock</a>
                      </li>
                      <li>
                          <a href="/stocks">Manage Stock</a>
                      </li>
                  </ul>
              </li>
              <li>
                  ...
                  <ul class="nav-2-level collapse">
                      ...
                      <li>
                          <a href="datatables.html">Manage Invoice</a>
                      </li>
                  </ul>
              </li>
              <li>
